...
import type { Seat, SeatType, SeatStatus } from '@/types/booking'
...
export function SeatButton({ seat, isSelected, onSelect, disabled }: SeatButtonProps) {
        ...
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              ...
              'border-2 border-b-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring',
              ...
              // VIP styling
              seat.type === 'vip' && isAvailable && !isSelected && 'bg-purple-600/80 border-purple-500 hover:bg-purple-500',
              seat.type === 'vip' && isSelected && 'bg-amber-500 border-amber-400',
              // Couple styling
              seat.type === 'couple' && isAvailable && !isSelected && 'bg-pink-600/80 border-pink-500 hover:bg-pink-500',
              seat.type === 'couple' && isSelected && 'bg-amber-500 border-amber-400',
              // Disabled state
          ...
          >
            <span className={cn(
              ...
              (isAvailable || isSelected || isHeld) && 'text-white'
            )}>
              {seat.type === 'couple' ? (
