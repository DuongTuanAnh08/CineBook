...
import type { Seat, SeatPricing } from '@/types/booking'
...
const DEFAULT_PRICING: SeatPricing = {
  standard: 75000,
  vip: 100000,
  couple: 180000,
}
              ...
              {seatLayout.rows.map((row) => (
                <div key={row.row} className="flex items-center gap-2">
                  ...
                  <div className={cn(
                    ...
                    row.row === 'J' || row.row === 'K' ? 'gap-4' : 'gap-1.5'
                  )}>
                      ...
                      return (
                        <div key={seat.id} className="flex items-center">
                          <SeatButton
                            ...
                            disabled={selectedSeats.length >= maxSeats && !selectedSeats.some((s) => s.id === seat.id)}
                          />
