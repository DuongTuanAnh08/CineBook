...
import { LayoutDashboard, Film, Calendar, MapPin, Users, Ticket, Tag, BarChart3, Settings, ChevronLeft, ChevronRight, Clapperboard, Armchair, ShoppingCart, RefreshCw, FileBarChart2, Newspaper } from 'lucide-react';
const sidebarGroups = [{
  title: 'Tổng quan',
  items: [{
    label: 'Dashboard',
