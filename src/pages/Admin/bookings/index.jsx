...
export default function AdminBookingsPage() {
  ...
  const filtered = mockBookings.filter(b => {
    const matchSearch = b.id.toLowerCase().includes(search.toLowerCase()) || b.customer.toLowerCase().includes(search.toLowerCase()) || b.movie.toLowerCase().includes(search.toLowerCase());
    const matchStatus = statusFilter === 'all' || b.status === statusFilter;
    return matchSearch && matchStatus;
  });
  const totalRevenue = mockBookings.filter(b => b.status === 'completed').reduce((a, b) => a + b.amount, 0);
  return (
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {booking.status === 'pending' && <DropdownMenuItem className="gap-2 text-destructive focus:text-destructive">
