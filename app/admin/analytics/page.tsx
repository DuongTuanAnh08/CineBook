...
const revenueData = [
  { month: 'T1', revenue: 1200, tickets: 800 },
  { month: 'T2', revenue: 1500, tickets: 1000 },
  { month: 'T3', revenue: 1100, tickets: 730 },
  { month: 'T4', revenue: 1800, tickets: 1200 },
  { month: 'T5', revenue: 2100, tickets: 1400 },
  { month: 'T6', revenue: 2400, tickets: 1600 },
  { month: 'T7', revenue: 2800, tickets: 1900 },
  { month: 'T8', revenue: 2600, tickets: 1750 },
  { month: 'T9', revenue: 2200, tickets: 1480 },
  { month: 'T10', revenue: 2900, tickets: 1950 },
  { month: 'T11', revenue: 3100, tickets: 2100 },
  { month: 'T12', revenue: 3500, tickets: 2350 },
]

const genreData = [
  { name: 'Hành động', value: 35, color: '#E50914' },
  { name: 'Hoạt hình', value: 22, color: '#F59E0B' },
  { name: 'Tâm lý', value: 18, color: '#3B82F6' },
  { name: 'Hài hước', value: 14, color: '#10B981' },
  { name: 'Kinh dị', value: 11, color: '#8B5CF6' },
]

const cinemaData = [
  { name: 'Vincom Mega Mall', tickets: 4200, revenue: 630 },
  { name: 'Landmark 81', tickets: 3800, revenue: 570 },
  { name: 'Royal City', tickets: 3100, revenue: 465 },
  { name: 'Aeon Mall', tickets: 2700, revenue: 405 },
  { name: 'Times City', tickets: 2400, revenue: 360 },
]
...
const summaryStats = [
  { title: 'Doanh thu năm', value: '₫28.2B', change: '+18.3%', positive: true, icon: DollarSign },
  { title: 'Tổng vé bán', value: '18,280', change: '+12.1%', positive: true, icon: Ticket },
  { title: 'Khách hàng mới', value: '2,341', change: '-4.5%', positive: false, icon: Users },
