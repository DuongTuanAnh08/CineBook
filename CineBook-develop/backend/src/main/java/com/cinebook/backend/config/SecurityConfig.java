    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/movies", "/api/movies/**", "/api/showtimes", "/api/showtimes/**", "/api/cinemas", "/api/cinemas/**", "/api/rooms", "/api/rooms/**", "/api/concessions", "/api/concessions/**", "/api/fnb", "/api/fnb/**", "/api/promos", "/api/promos/**", "/api/news", "/api/news/**", "/api/reviews", "/api/reviews/**", "/api/config", "/api/config/**", "/api/resale", "/api/resale/**", "/uploads/**", "/api/genres", "/api/genres/**", "/api/actors", "/api/actors/**").permitAll()
                // Swagger UI
